...
export type EnlivenObjectOptions = Abortable & {
     ...
     */
    reviver?: <T extends BaseFabricObject | FabricObject | BaseFilter | Shadow | TFiller>(serializedObj: Record<string, any>, instance: T) => void;
};
/**
