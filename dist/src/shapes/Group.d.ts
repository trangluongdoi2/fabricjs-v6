...
declare const Group_base: {
    ...
    type: string;
    _fromObject<S extends import("./Object/Object").FabricObject<Partial<import("./Object/types/ObjectProps").ObjectProps>, SerializedObjectProps, ObjectEvents>>({ type, ...object }: Record<string, unknown>, { extraParam, ...options }?: import("../typedefs").Abortable & {
...
export declare class Group extends Group_base implements GroupProps {
     ...
     */
    static fromObject<T extends TOptions<SerializedGroupProps>>({ type, objects, layoutManager, ...options }: T): Promise<Group>;
}
export {};
